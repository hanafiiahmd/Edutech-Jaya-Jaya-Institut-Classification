...
with col1:
    prev_qualification = st.slider("Nilai Kualifikasi Sebelumnya", min_value=0.0, max_value=200.0, step=0.1)
    admission_grade = st.slider("Nilai Penerimaan", min_value=0.0, max_value=200.0, step=0.1)
